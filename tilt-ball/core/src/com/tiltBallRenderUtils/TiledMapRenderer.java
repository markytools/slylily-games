...
public class TiledMapRenderer extends BatchTiledMapRenderer {
	...
	public TiledMapRenderer (MyTiledMap map) {
		super(map);
	}

	public TiledMapRenderer (MyTiledMap map, Batch batch) {
		super(map, batch);
	}

	public TiledMapRenderer (MyTiledMap map, float unitScale) {
		super(map, unitScale);
	}

	public TiledMapRenderer (MyTiledMap map, float unitScale, Batch batch) {
	...
	public void renderTileLayer (TiledMapTileLayer layer) {
		MyTiledMap map = (MyTiledMap) getMap();
